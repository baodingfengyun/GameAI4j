...
import com.jzy.ai.btree.LoopDecorator;
import com.jzy.ai.btree.Task;
import com.jzy.ai.btree.annotation.TaskAttribute;
...
public class Repeat<E> extends LoopDecorator<E> {
     ...
     * value means forever.
     *
     * @param times the integer distribution specifying how many times the child must
     *              be repeated. 负数，无限循环
     * @param child the task that will be wrapped
     */
