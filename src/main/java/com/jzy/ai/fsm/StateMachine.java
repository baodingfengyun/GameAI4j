...
public interface StateMachine<E, S extends State<E>> extends Telegraph {
     ...
     * <p>
     * Implementation classes should invoke first the {@code update} method of the
     ...
     * <p>
     * Implementation classes should invoke the {@code update} method of the global
     * state every time the FSM is updated. Also, they should never invoke its
     ...
     * <p>
     * Implementation classes should first route the telegram to the current state.
     * If the current state does not deal with the message, it should be routed to
     * the global state.
     * </p>
     *
